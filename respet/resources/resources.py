...
hrdwr_mu = [   
    ...
    'umap_HOMCU_10606489.v.hdr',   # (2) Head and neck upper coil
...
DEV_ID = 0
CC_ARCH = '-gencode=arch=compute_61,code=compute_61;-gencode=arch=compute_35,code=compute_35;'
### end GPU properties ###

# paths to apps and tools needed by NiftyPET
### start NiftyPET tools ###
PATHTOOLS = '/home/usr/jjlee/Local/NiftyPET_tools'
RESPATH = '/home/usr/jjlee/Local/NiftyPET_tools/niftyreg/bin/reg_resample'
REGPATH = '/home/usr/jjlee/Local/NiftyPET_tools/niftyreg/bin/reg_aladin'
DCM2NIIX = '/home/usr/jjlee/Local/NiftyPET_tools/dcm2niix/bin/dcm2niix'
HMUDIR = '/data/nil-bluearc/raichle/jjlee/Local/JSRecon12e11p/hardwareumaps'
### end NiftyPET tools ###
# -----------------------------------------------------
